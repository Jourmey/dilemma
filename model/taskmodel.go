...
type (
	...
	Task struct {
		...
		Tag        int64     `db:"tag"`         // 标签
		Status     int64     `db:"status"`      // 任务状态 0未处理 1获取信息
...
func (m *defaultTaskModel) FindOne(id int64) (*Task, error) {
...
func (m *defaultTaskModel) Delete(id int64) error {
